    ...
    <div className="min-h-screen bg-surface-950 font-sans selection:bg-brand-500/30 selection:text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-6 py-8 sm:px-12">
        <div className="glass-light rounded-full px-6 py-2.5 flex items-center shadow-premium-lg">
          <div className="text-xs font-black tracking-tighter text-white/90">ONFANS FACTORY</div>
        </div>
      </nav>
      ...
      <section className="pt-32 pb-12 px-6 sm:px-12 sm:pt-48">
        <div className="mx-auto max-w-5xl text-center animate-fade-in-up">
          <h1 className="mb-6 text-[36px] font-black leading-[1.1] tracking-tight text-white sm:text-7xl lg:text-8xl break-keep">
            수만 명의 셀러와 연결되는
            <span className="block text-gradient mt-2">가장 빠른 방법.</span>
          </h1>
      ...
      <section className="px-6 pb-32 sm:px-12 animate-fade-in duration-700">
        <div className="mx-auto max-w-2xl rounded-[2.5rem] bg-white p-8 sm:p-14 shadow-premium-xl relative overflow-hidden">
          ...
          <div className="mb-10 flex items-center justify-between border-b border-surface-100 pb-8">
            <div>
              <h2 className="text-3xl font-bold tracking-tight text-surface-950 sm:text-4xl">공장 입점 신청</h2>
              <p className="mt-2 text-surface-500 font-medium">제조사/공급사 파트너로 합류하세요.</p>
            </div>
            ...
            <div className="flex flex-col gap-8 animate-scale-in">
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-sm text-surface-500 font-medium">위탁 배송 / 드랍쉬핑 시스템이 준비되어 있습니다.</span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-sm text-surface-500 font-medium">사입(도매) 방식으로만 거래합니다.</span>
                  </div>
                </button>
              </div>
              ...
              {isDropshipping === false && (
                <div className="mt-2 rounded-2xl bg-red-50 p-6 text-center animate-blur-in">
                  ...
                  <h4 className="mb-2 font-bold text-red-950">입점이 불가능합니다</h4>
                  <p className="text-sm text-red-800 font-medium leading-relaxed">
                    현재 온팬즈는 <span className="font-bold underline underline-offset-2">위탁 배송(드랍쉬핑)</span>이 가능한 파트너와만 협업하고 있습니다. 귀하의 비즈니스에 행운이 깃들길 바랍니다.
                  </p>
                </div>
              )}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8 animate-scale-in">
              ...
              <div className="space-y-6">
                <div className="flex flex-col gap-2.5">
                  <label htmlFor="company_name" className="text-sm font-bold text-surface-900 ml-1">공급사(공장) 이름</label>
                  <input 
                    type="text" 
                    id="company_name" 
                    name="company_name" 
                ...
                <div className="flex flex-col gap-2.5">
                  <label htmlFor="product_image_url" className="text-sm font-bold text-surface-900 ml-1">주력 제품 이미지 (URL)</label>
                  <input 
                    type="url" 
                    ...
                    className="w-full rounded-2xl border-2 border-surface-100 bg-surface-50 px-5 py-4 font-bold text-surface-950 transition-all focus:border-surface-950 focus:bg-white focus:outline-none placeholder:text-surface-300"
                  />
                  <span className="text-xs text-surface-400 ml-1 font-medium italic">제품을 확인할 수 있는 이미지 링크나 상세페이지 링크를 입력해주세요.</span>
                </div>

                <div className="grid grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2.5">
                    <label htmlFor="consumer_price" className="text-sm font-bold text-surface-900 ml-1">소비자가 (원)</label>
                    <input 
                      type="number" 
                      id="consumer_price" 
                      name="consumer_price" 
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    입점 신청 완료하기 <CheckCircle2 size={22} />
                  </>
                )}
              </button>
            </form>
